...
//
//	Copied from Apple's example code "AdvancedUserInterfacesUsingCollectionView" project.
//
...
@protocol MCC_PREFIXED_NAME(StateMachineDelegate) <NSObject>
...
@interface MCC_PREFIXED_NAME(StateMachine) : NSObject
...
@property (MCC_WEAK, atomic) id<MCC_PREFIXED_NAME(StateMachineDelegate)> delegate;
